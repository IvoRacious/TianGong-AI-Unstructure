...
LOG_FILE = "celery_two_stage_urgent.log"
DEFAULT_INPUT_DIR = Path("test/journal-test/urgent")
DEFAULT_OUTPUT_DIR = Path("test/journal-test/pickle-urg")
...
PRIORITY = (os.environ.get("TWO_STAGE_PRIORITY") or "urgent").strip().lower() or "urgent"
